...
/**
 * WorkerMetricsProcessor implementation that allows the supervisor to directly insert metrics into Yamas instead
 * of forwarding metrics to Nimbus for processing.
 */
public class YamasMetricProcessor extends YamasStore implements WorkerMetricsProcessor {
    @Override
